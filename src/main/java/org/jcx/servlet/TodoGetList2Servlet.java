...
@WebServlet("/todo/get2")
public class TodoGetList2Servlet extends HttpServlet {
    //除了user的查询变为精准查询，其他的同/todo/get
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        List<Todo> todoList = todoService.todoGetList2(
                idLike,user,titleLike,contentLike,tagLike,classifyLike,istopLike,iscircleLike,iscomplete,
                pageIndex,pageSize);
