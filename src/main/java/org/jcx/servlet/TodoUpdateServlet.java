...
public class TodoUpdateServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        System.out.println("——————————————————————————*****——————————————————————————");
        System.out.println("与前端交锋最前线：servlet\tTodoUpdateServlet\t太长了不打印");

        ITodoService todoService = new ToDoServiceImpl();
        Integer data = todoService.todoUpdate(id,user,title,content,tag,classify,istop,iscircle,iscomplete);
